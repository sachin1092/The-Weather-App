 ...
 * more than a {@link com.sachinshinde.theweatherapp.ui.main.fragments.LocationDetailFragment}.
 */
public class LocationDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putLong(LocationDetailFragment.ARG_ITEM_ID,
                    getIntent().getLongExtra(LocationDetailFragment.ARG_ITEM_ID, -1));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                //
                NavUtils.navigateUpTo(this, new Intent(this, LocationListActivity.class));
                return true;
        }
